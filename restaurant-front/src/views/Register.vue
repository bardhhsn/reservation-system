      ...
      <div class="bg-white shadow-md rounded-xl p-8 w-full max-w-md">
        ...
        <form @submit.prevent="register">
          <div class="mb-4">
            ...
            <input v-model="name" type="text" class="w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-green-400" required />
          </div>
          <div class="mb-4">
            <label class="block mb-1 text-gray-700">Email</label>
            <input v-model="email" type="email" class="w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-green-400" required />
          </div>
          <div class="mb-6">
            <label class="block mb-1 text-gray-700">Fjalëkalimi</label>
            <input v-model="password" type="password" class="w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-green-400" required />
          </div>
    ...
    methods: {
      async register() {
        ...
        try {
          ...
          this.message = 'U regjistrua me sukses! Tani mund të kyçesh.'
        } catch (err) {
